document.addEventListener('DOMContentLoaded', function () {
    ...
    if (document.querySelector('.section-htb-tab-item') && document.querySelector('.section-htb-tab-item').classList.contains('section-htb-tab-item')) {
        var sectionHowTabs = document.querySelectorAll('.section-htb-tab-item')
        var sectionHowTabsBtns = document.querySelector('.section-htb-tap-wrap').children
    }



    if (document.querySelector('.section-htb-tab-item') && sectionLandTabs) {
    ...
    function fruithidden(n) {
        if (document.querySelector('.section-htb-fruit-wrap')) {
            if (widthOutput <= 560) {
                sectionHowFruit.style.display = "none"
            }
    ...
    if (document.querySelector('#scroller02')) {
    ...
    if (document.querySelector('#scroller03')) {
    ...
    if (document.querySelector('#scroller04')) {
    ...
    if (document.querySelector('#scroller05')) {
    ...
    if (document.querySelector('#scroller06')) {
    ...
    if (document.querySelector('#scroller07')) {
    ...
    if (document.querySelector('#scroller08')) {
    ...
    if (document.querySelector('#scroller09')) {
    ...
    if (document.querySelector('#scroller10')) {
    ...
    if (document.querySelector('#scroller11')) {
